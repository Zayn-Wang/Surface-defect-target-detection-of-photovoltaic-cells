...
class IOUloss(nn.Module):
    def __init__(self, loss_type, reduction="none", alpha=3):
...
class YOLOLoss(nn.Module):    
    def __init__(self, num_classes, fp16,iou_loss_type, obj_loss_type, strides=[8, 16, 32]):
        super().__init__()
        ...
        self.iou_loss           = IOUloss(reduction="none",loss_type=self.iou_loss_type)
